...
export const Tooltip: React.FC<TooltipProps> = ({ content, position = "top", children, delay = 0.3 }) => {
    ...
    <div className="relative inline-block">
      ...
      <AnimatePresence>
        {isVisible && (
          ...
          >
            <div className="bg-gray-800 text-white text-sm rounded px-2 py-1 max-w-xs">{content}</div>
